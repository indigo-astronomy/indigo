...
#define ascol_FOSR(devfd, position) (ascol_1_double_param_cmd(devfd, "FOSR", position, 2))
#define ascol_FOSA(devfd, position) (ascol_1_double_param_cmd(devfd, "FOSA", position, 2))
...
#define ascol_DOSR(devfd, position) (ascol_1_double_param_cmd(devfd, "DOSR", position, 2))
#define ascol_DOSA(devfd, position) (ascol_1_double_param_cmd(devfd, "DOSA", position, 2))
