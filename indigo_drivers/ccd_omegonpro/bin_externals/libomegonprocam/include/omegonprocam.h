...
#define OMEGONPROCAM_GVCP_RETRY_MAX            16
#define OMEGONPROCAM_GVCP_TIMEOUT_DEF          15      /* GVCP Timeout */
#define OMEGONPROCAM_GVCP_TIMEOUT_MIN          5
#define OMEGONPROCAM_GVCP_TIMEOUT_MAX          150
