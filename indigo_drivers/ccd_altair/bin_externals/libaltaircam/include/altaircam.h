...
#define ALTAIRCAM_HEAT_MIN                  0       /* Heat */
#define ALTAIRCAM_LANE_MIN                  0       /* Lane */
#define ALTAIRCAM_FAN_MIN                   0       /* Fan */
...
*/
#if defined(_WIN32)
ALTAIRCAM_API(HRESULT)  Altaircam_Load(HAltaircam h, const wchar_t* strPara);
#else
ALTAIRCAM_API(HRESULT)  Altaircam_Load(HAltaircam h, const char* strPara);
#endif
...
#define ALTAIRCAM_EVENT_FRONT_OVERFLOW    0x0010    /* front buffer overflow */
#define ALTAIRCAM_EVENT_BACK_OVERFLOW     0x0011    /* back buffer overflow */
...
#define ALTAIRCAM_FRAMEINFO_FLAG_HOB                0x00000400 /* Horizontal Optical Black */
#define ALTAIRCAM_FRAMEINFO_FLAG_VOB                0x00000800 /* Vertical Optical Black */
...
ALTAIRCAM_API(HRESULT)  Altaircam_put_AWBAuxRect(HAltaircam h, const RECT* pRect); /* auto white balance ROI */
ALTAIRCAM_API(HRESULT)  Altaircam_get_AWBAuxRect(HAltaircam h, RECT* pRect);
ALTAIRCAM_API(HRESULT)  Altaircam_put_AEAuxRect(HAltaircam h, const RECT* pRect);  /* auto exposure ROI */
ALTAIRCAM_API(HRESULT)  Altaircam_get_AEAuxRect(HAltaircam h, RECT* pRect);

ALTAIRCAM_API(HRESULT)  Altaircam_put_ABBAuxRect(HAltaircam h, const RECT* pRect); /* auto black balance ROI */
ALTAIRCAM_API(HRESULT)  Altaircam_get_ABBAuxRect(HAltaircam h, RECT* pRect);
...
/* Case insensitive */
ALTAIRCAM_API(HRESULT)  Altaircam_put_Int(HAltaircam h, const char* strName, int iValue);
ALTAIRCAM_API(HRESULT)  Altaircam_get_Int(HAltaircam h, const char* strName, int* piValue);
ALTAIRCAM_API(HRESULT)  Altaircam_put_Str(HAltaircam h, const char* strName, const char* strValue);
/* strValue: output buffer (128 bytes are always sufficient) */
ALTAIRCAM_API(HRESULT)  Altaircam_get_Str(HAltaircam h, const char* strName, char strValue[]);
ALTAIRCAM_API(HRESULT)  Altaircam_get_Enum(HAltaircam h, const char* strName, int* pNumber, int arrValue[], const char* arrString[]);
ALTAIRCAM_API(HRESULT)  Altaircam_get_StrPtr(HAltaircam h, const char* strName, const char** strValue);
...
#define ALTAIRCAM_OPTION_SCANTYPE               0x8e       /* [RW] Scan Type: 0(areascan), 1(linescan) */
...
#define ALTAIRCAM_IOCONTROLTYPE_GET_PWM_FREQ                 0x19 /* PWM Frequency, range: [0, 0xffffffff] */
#define ALTAIRCAM_IOCONTROLTYPE_SET_PWM_FREQ                 0x1a
#define ALTAIRCAM_IOCONTROLTYPE_GET_PWM_DUTYRATIO            0x1b /* PWM Duty Ratio, default: 50, range: [0, 100] */
...
#define ALTAIRCAM_IOCONTROLTYPE_GET_EXPO_START_LINE          0x31 /* exposure start line, default: 0, range: [0, 16384] */
#define ALTAIRCAM_IOCONTROLTYPE_SET_EXPO_START_LINE          0x32
#define ALTAIRCAM_IOCONTROLTYPE_GET_EXPO_END_LINE            0x33 /* exposure end line, default: 0, range: [0, 16384]
...
#define ALTAIRCAM_IOCONTROLTYPE_GET_USER_PULSE_HIGH          0x3d /* User pulse high level time: us, range: [0, 0xffffffff] */
#define ALTAIRCAM_IOCONTROLTYPE_SET_USER_PULSE_HIGH          0x3e
#define ALTAIRCAM_IOCONTROLTYPE_GET_USER_PULSE_LOW           0x3f /* User pulse low level time: us, range: [0, 0xffffffff] */
#define ALTAIRCAM_IOCONTROLTYPE_SET_USER_PULSE_LOW           0x40
#define ALTAIRCAM_IOCONTROLTYPE_GET_USER_PULSE_NUMBER        0x41 /* User pulse number: default 0, range: [0, 0xffffffff] */
