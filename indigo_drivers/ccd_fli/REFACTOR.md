...
Verification: the complete fake SDK suite was re-run after regeneration —
`indigo_test/build/integration/test_ccd_fli_sdk`, macOS arm64, 22/22 passed on 2026-09-21 12:45.
