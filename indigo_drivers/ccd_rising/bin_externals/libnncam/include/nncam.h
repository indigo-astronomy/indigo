...
#define NNCAM_OPTION_LDC                    0x97       /* [RW] Low Dark Current, 0 => disable, 1 => enable */
...
*/
NNCAM_API(HRESULT)  Nncam_GigeEnableV2(PNNCAM_HOTPLUG funHotPlug, void* ctxHotPlug, const char* opt);
