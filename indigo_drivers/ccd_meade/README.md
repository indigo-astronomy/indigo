# Meade DSI CCD camera, filter wheel and focuser driver

https://meade-instruments.com/

## Supported devices

Meade USB 2.0 and USB 3.0 devices (cameras, filter wheels and focusers) supported by the vendor SDK. This driver supports only Meade caameras and products produced by Touptek.
...
indigo_server indigo_ccd_meade
