...
Driver version is now `0x0300000A`. Regression coverage is the existing suite in
`indigo_test/integration/test_focuser_primaluce_simulator.c`, which was re-run after the change.
