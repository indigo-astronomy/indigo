...
| Abort in motion and idle, stop failure, fresh move after abort, abort overtaking queued start | `abort_motion`, `urgent_abort_cancels_queued_move` |
...
- Simulated (fake-SDK) tests, final generated driver: 32 registered cases; final ordinary run 32 run, 32 passed; final ASan/UBSan run 32 run, 32 passed.
