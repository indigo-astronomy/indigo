...
#define OGMACAM_IOCONTROLTYPE_GET_USER_PULSE_HIGH         0x3e /* User pulse high level time: us */
#define OGMACAM_IOCONTROLTYPE_SET_USER_PULSE_HIGH         0x3f
#define OGMACAM_IOCONTROLTYPE_GET_USER_PULSE_LOW          0x40 /* User pulse low level time: us */
#define OGMACAM_IOCONTROLTYPE_SET_USER_PULSE_LOW          0x41
#define OGMACAM_IOCONTROLTYPE_GET_USER_PULSE_NUMBER       0x42 /* User pulse number: default 0 */
#define OGMACAM_IOCONTROLTYPE_SET_USER_PULSE_NUMBER       0x43
