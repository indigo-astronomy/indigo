...
#define ascol_TRRA(devfd, ra, de, west) (ascol_3_ra_de_w_return_cmd(devfd, "TRRA", ra, de, west))
...
#define ascol_TRRD(devfd, ra, de, west) (ascol_3_ra_de_w_return_cmd(devfd, "TRRD", ra, de, west))
