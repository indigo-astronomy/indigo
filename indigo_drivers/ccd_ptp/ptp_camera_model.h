...
static ptp_camera_model CAMERA[] = {
  ...
  { CANON_VID, 0x32e7, "Canon EOS M6 Mark II", ptp_flag_lv, 6960, 4640, 3.2 },
  { CANON_VID, 0x32e8, "Canon EOS 1D X Mark III", ptp_flag_lv, 5472, 3648, 6.56 },
  { CANON_VID, 0x32e9, "Canon EOS 250D", ptp_flag_lv, 6000, 4000, 3.71 },
  { CANON_VID, 0x32ea, "Canon EOS 90D", ptp_flag_lv, 6960, 4640, 3.2 },
  { CANON_VID, 0x32ef, "Canon EOS M200", ptp_flag_lv, 6000, 4000, 3.71 },
  { CANON_VID, 0x32f1, "Canon EOS 850D", ptp_flag_lv, 6000, 4000, 3.71 },
  { CANON_VID, 0x32f4, "Canon EOS R5", ptp_flag_lv, 8192, 5464, 4.4 },
  { CANON_VID, 0x32f5, "Canon EOS R6", ptp_flag_lv, 5472, 3648, 6.56 },
  { CANON_VID, 0x32f7, "Canon EOS R7", ptp_flag_lv, 6960, 4640, 3.2 },
  { CANON_VID, 0x32f8, "Canon EOS R10", ptp_flag_lv, 6000, 4000, 3.71 },
  { CANON_VID, 0x32f9, "Canon EOS M50 Mark II", ptp_flag_lv, 6000, 4000, 3.71 },
  { CANON_VID, 0x32fc, "Canon EOS R3", ptp_flag_lv, 6000, 4000, 6.0 },
  { CANON_VID, 0x330b, "Canon EOS R6 Mark II", ptp_flag_lv, 6000, 4000, 6.0 },
  { CANON_VID, 0x330c, "Canon EOS R8", ptp_flag_lv, 6000, 4000, 6.0 },
  { CANON_VID, 0x330d, "Canon EOS R50", ptp_flag_lv, 6000, 4000, 3.71 },
  { CANON_VID, 0x3312, "Canon EOS R100", ptp_flag_lv, 6000, 4000, 3.71 },
  { CANON_VID, 0x3313, "Canon EOS R1", ptp_flag_lv, 6000, 4000, 6.0 },
  { CANON_VID, 0x3314, "Canon EOS R5 Mark II", ptp_flag_lv, 6000, 4000, 6.0 },
  { CANON_VID, 0xFFFF, "Canon Camera", ptp_flag_lv, 0, 0, 0 },
  { FUJI_VID, 0x02bf, "Fujifilm X-T1", ptp_flag_lv, 4896, 3264, 4.8 },
  { FUJI_VID, 0x02cb, "Fujifilm X-Pro2", ptp_flag_lv, 6000, 4000, 3.9 },
  { FUJI_VID, 0x02cd, "Fujifilm X-T2", ptp_flag_lv, 6000, 4000, 3.9 },
  { FUJI_VID, 0x02d3, "Fujifilm GFX 50S", ptp_flag_lv, 8256, 6192, 5.3 },
  ...
  { SONY_VID, 0x094c, "Sony Alpha A7", 0, 6000, 4000, 5.98 },
  { SONY_VID, 0x094d, "Sony Alpha A7R", 0, 7360, 4912, 4.9 },
  ...
  { SONY_VID, 0x0957, "Sony Alpha A5100", 0, 6000, 4000, 3.92 },
  ...
  { SONY_VID, 0x0a71, "Sony Alpha A7SII", ptp_flag_lv, 4240, 2832, 8.39 },
  ...
  { SONY_VID, 0x0c43, "Sony Alpha A9II", ptp_flag_lv, 6000, 4000, 5.98 },
  { SONY_VID, 0x0caa, "Sony Alpha A6400", ptp_flag_lv, 6000, 4000, 3.92 },
  { SONY_VID, 0x0ccc, "Sony Alpha A7RIV", ptp_flag_lv, 9504, 6336, 3.76 },
  { SONY_VID, 0x0d18, "Sony Alpha A7SIII", ptp_flag_lv, 4240, 2832, 8.39 },
  { SONY_VID, 0x0d1c, "Sony Alpha A1", ptp_flag_lv, 8640, 5760, 4.16 },
  { SONY_VID, 0x0d2b, "Sony Alpha A7C", ptp_flag_lv, 6000, 4000, 5.93 },
  { SONY_VID, 0x0da7, "Sony Alpha A7IV", ptp_flag_lv, 7008, 4672, 5.12 },
  ...
  { OLYMPUS_VID, 0x0136, "OM System OM-1", ptp_flag_lv, 5184, 3888, 3.35 },
  { OLYMPUS_VID, 0xFFFF, "Olympus Camera", ptp_flag_lv, 0, 0, 0 },
  { OM_SYSTEM_VID, 0x0136, "OM System OM-1", ptp_flag_lv, 5184, 3888, 3.35 },
  { OM_SYSTEM_VID, 0xFFFF, "OM System Camera", ptp_flag_lv, 0, 0, 0 },
  { 0 },
};
