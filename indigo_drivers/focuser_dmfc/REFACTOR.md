...
Driver version is now `0x03000010`. Regression coverage is the existing suite in
`indigo_test/integration/test_focuser_dmfc_simulator.c`, which was re-run after the change.
