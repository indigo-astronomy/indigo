...
#define SVBONYCAM_FRAMEINFO_FLAG_HOB                0x00000400 /* Horizontal Optical Black */
#define SVBONYCAM_FRAMEINFO_FLAG_VOB                0x00000800 /* Vertical Optical Black */
...
SVBONYCAM_API(HRESULT)  Svbonycam_put_AWBAuxRect(HSvbonycam h, const RECT* pRect); /* auto white balance ROI */
SVBONYCAM_API(HRESULT)  Svbonycam_get_AWBAuxRect(HSvbonycam h, RECT* pRect);
SVBONYCAM_API(HRESULT)  Svbonycam_put_AEAuxRect(HSvbonycam h, const RECT* pRect);  /* auto exposure ROI */
SVBONYCAM_API(HRESULT)  Svbonycam_get_AEAuxRect(HSvbonycam h, RECT* pRect);

SVBONYCAM_API(HRESULT)  Svbonycam_put_ABBAuxRect(HSvbonycam h, const RECT* pRect); /* auto black balance ROI */
SVBONYCAM_API(HRESULT)  Svbonycam_get_ABBAuxRect(HSvbonycam h, RECT* pRect);
