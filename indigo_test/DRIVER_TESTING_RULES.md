...
| Positioning | First/last and one intermediate slot, already-selected slot, driver handling of invalid/fractional requests after framework validation. Verify command index, BUSY/poll/OK sequence and actual slot readback; overlapping requests follow documented rejection/replacement behavior. |
