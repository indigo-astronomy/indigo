...
Inventory: 150 modules — 4 Complete, 47 Partial, 53 Not audited, 46 No tests.
...
| `ccd_atik` | Generated | Fake SDK/USB | Complete | 37 scenario groups, with version assertion rerun; Titan feature/active-removal scenarios passed; idle replug crashed once, other models pending. See Atik acceptance below. |
