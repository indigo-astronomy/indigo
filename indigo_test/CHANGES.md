...
| `ccd_atik` | Generated | Fake SDK/USB | Complete | 40 scenario groups passed; Titan and One feature scenarios passed; Titan idle replug crashed once; One hot-plug and 11000A/Horizon pending. See Atik acceptance below. |
...
The opt-in hardware client now tests all wheel slots and restoration, plus cooling convergence/power, a cooled image, cooler OFF and original target/selection restoration. One passed exposure/reconnect/reload, all advertised bins/ROI, read modes, five frame types, abort/restart, cooling and all five wheel positions including wraparound. One exposes no guider/heater/presets/gain/offset in this run. Physical One hot-plug, 11000A/Horizon, electrical/optical accuracy and full warm-up measurement remain unverified; see REFACTOR.md and TESTING.md for evidence. No README changes.
