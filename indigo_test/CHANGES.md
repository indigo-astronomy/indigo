...
- `test_rotator_simulator.c`: rotator simulator metadata, lifecycle, property enumeration, connection/disconnection, direction reversal position mapping, and rotator compliance checks.
