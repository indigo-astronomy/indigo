...
|  |  |  |  | PAUSE_AT_HA | yes | Resume batch paused at configured HA (e.g. after meridian flip) |
...
|  |  |  |  | PAUSE_AT_HA | yes | Pause batch when HA reached; e.g. before meridian flip; use 24:00:00 to turn it off  |
