...
In INDIGO Imager Agent auto-focus starts with a large step to approximate the focus progressively decreasing it until it finishes making adjustments with its final step. This is why the final step is important for the focusing accuracy.
