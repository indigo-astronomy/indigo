...
1. Select a driver, transport, device, property, or code block in the left tree. The tree can be filtered; all branches remain expanded. Select an item in the tree to edit it; item settings are not shown in the parent property’s detail panel.
