...
#define AGENT_GUIDER_DETECTION_MULTIPOINT_ITEM_NAME		"MULTIPOINT"
...
/* Multipoint guide related items */
#define AGENT_GUIDER_SELECTION_MULTIPOINT_COUNT_ITEM_NAME		"MULTIPOINT_COUNT"
