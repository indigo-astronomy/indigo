...
#define AGENT_GUIDER_CORRECTION_MODE_LOWPASS_ITEM_NAME		"LOWPASS"
...
#define AGENT_GUIDER_SETTINGS_LOWPASS_WEIGHT_RA_ITEM_NAME	"LOWPASS_SLOPE_WEIGHT_RA"
#define AGENT_GUIDER_SETTINGS_LOWPASS_WEIGHT_DEC_ITEM_NAME	"LOWPASS_SLOPE_WEIGHT_DEC"
