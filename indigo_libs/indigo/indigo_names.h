...
#define AGENT_CONFIG_SETUP_AUTOSAVE_ITEM_NAME			  	"AUTOSAVE_DEVICE_CONFIGURATIONS"
...
#define AGENT_CONFIG_REMOVE_PROPERTY_NAME							"AGENT_CONFIG_REMOVE"
#define AGENT_CONFIG_REMOVE_NAME_ITEM_NAME			  		"NAME"
