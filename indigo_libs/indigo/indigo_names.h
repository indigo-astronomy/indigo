...
#define AGENT_GUIDER_SETTINGS_MAIN_CCD_IMG_PIXEL_SCALE_WIDTH_ITEM_NAME					"PIXEL_SCALE_WIDTH"
#define AGENT_GUIDER_SETTINGS_MAIN_CCD_IMG_PIXEL_SCALE_HEIGHT_ITEM_NAME				"PIXEL_SCALE_HEIGHT"
