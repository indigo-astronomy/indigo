...
#define FILTER_FORCE_SYMETRIC_RELATIONS_PROPERTY_NAME				"FILTER_FORCE_SYMETRIC_RELATIONS"
#define FILTER_FORCE_SYMETRIC_RELATIONS_ENABLED_ITEM_NAME		"ENABLED"
#define FILTER_FORCE_SYMETRIC_RELATIONS_DISABLED_ITEM_NAME	"DISABLED"
