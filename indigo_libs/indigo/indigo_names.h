...
/** CCD_JPEG_SETTINGS.GRAY property item name.
 */
#define CCD_JPEG_SETTINGS_GRAY_ITEM_NAME			"GRAY"

/** CCD_JPEG_SETTINGS.WHITE property item name.
 */
#define CCD_JPEG_SETTINGS_WHITE_ITEM_NAME			"WHITE"

/** CCD_JPEG_SETTINGS.BLACK_GREEN property item name.
 */
#define CCD_JPEG_SETTINGS_BLACK_GREEN_ITEM_NAME			"BLACK_GREEN"

/** CCD_JPEG_SETTINGS.GRAY_GREEN property item name.
 */
#define CCD_JPEG_SETTINGS_GRAY_GREEN_ITEM_NAME			"GRAY_GREEN"

/** CCD_JPEG_SETTINGS.WHITE_GREEN property item name.
 */
#define CCD_JPEG_SETTINGS_WHITE_GREEN_ITEM_NAME			"WHITE_GREEN"

/** CCD_JPEG_SETTINGS.BLACK_BLUE property item name.
 */
#define CCD_JPEG_SETTINGS_BLACK_BLUE_ITEM_NAME			"BLACK_BLUE"

/** CCD_JPEG_SETTINGS.GRAY_BLUE property item name.
 */
#define CCD_JPEG_SETTINGS_GRAY_BLUE_ITEM_NAME			"GRAY_BLUE"

/** CCD_JPEG_SETTINGS.WHITE_BLUE property item name.
 */
#define CCD_JPEG_SETTINGS_WHITE_BLUE_ITEM_NAME			"WHITE_BLUE"

/** CCD_JPEG_SETTINGS.BACKGROUND property item name.
 */
#define CCD_JPEG_SETTINGS_BACKGROUND_ITEM_NAME     "BACKGROUND"

/** CCD_JPEG_SETTINGS.CONTRAST property item name.
 */
#define CCD_JPEG_SETTINGS_CONTRAST_ITEM_NAME     "CONTRAST"
...
#define AGENT_IMAGER_BREAKPOINT_PRE_DITHER_ITEM_NAME		"PRE_DITHER"
#define AGENT_IMAGER_BREAKPOINT_POST_DITHER_ITEM_NAME		"POST_DITHER"
