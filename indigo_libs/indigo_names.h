...
//----------------------------------------------------------------------
/** COMMON_GEOGRAPHIC_COORDINATES property name.
 */
#define COMMON_GEOGRAPHIC_COORDINATES_PROPERTY_NAME	"COMMON_GEOGRAPHIC_COORDINATES"

/** COMMON_GEOGRAPHIC_COORDINATES.LATITUDE property item name.
 */
#define COMMON_GEOGRAPHIC_COORDINATES_LATITUDE_ITEM_NAME	"LATITUDE"

/** COMMON_GEOGRAPHIC_COORDINATES.LONGITUDE property item name.
 */
#define COMMON_GEOGRAPHIC_COORDINATES_LONGITUDE_ITEM_NAME	"LONGITUDE"

/** COMMON_GEOGRAPHIC_COORDINATES.ELEVATION property item name.
 */
#define COMMON_GEOGRAPHIC_COORDINATES_ELEVATION_ITEM_NAME	"ELEVATION"

//----------------------------------------------------------------------
/** COMMON_UTC_TIME property name.
 */
#define COMMON_UTC_TIME_PROPERTY_NAME						"COMMON_UTC_TIME"

/** COMMON_UTC_TIME.UTC property item name.
 */
#define COMMON_UTC_TIME_ITEM_NAME								"TIME"

/** COMMON_UTC_TIME.OFFSET property item name.
 */
#define COMMON_UTC_OFFSET_ITEM_NAME							"OFFSET"
 ...
 */
#define MOUNT_GEOGRAPHIC_COORDINATES_PROPERTY_NAME	COMMON_GEOGRAPHIC_COORDINATES_PROPERTY_NAME

/** MOUNT_GEOGRAPHIC_COORDINATES.LATITUDE property item name.
 */
#define MOUNT_GEOGRAPHIC_COORDINATES_LATITUDE_ITEM_NAME		COMMON_GEOGRAPHIC_COORDINATES_LATITUDE_ITEM_NAME

/** MOUNT_GEOGRAPHIC_COORDINATES.LONGITUDE property item name.
 */
#define MOUNT_GEOGRAPHIC_COORDINATES_LONGITUDE_ITEM_NAME	COMMON_GEOGRAPHIC_COORDINATES_LONGITUDE_ITEM_NAME

/** MOUNT_GEOGRAPHIC_COORDINATES.ELEVATION property item name.
 */
#define MOUNT_GEOGRAPHIC_COORDINATES_ELEVATION_ITEM_NAME	COMMON_GEOGRAPHIC_COORDINATES_ELEVATION_ITEM_NAME
 ...
 */
#define MOUNT_UTC_TIME_PROPERTY_NAME						COMMON_UTC_TIME_PROPERTY_NAME

/** MOUNT_UTC_TIME.UTC property item name.
 */
#define MOUNT_UTC_TIME_ITEM_NAME							COMMON_UTC_TIME_ITEM_NAME

/** MOUNT_UTC_TIME.OFFSET property item name.
 */
#define MOUNT_UTC_OFFSET_ITEM_NAME							COMMON_UTC_OFFSET_ITEM_NAME
 ...
 */
#define GPS_GEOGRAPHIC_COORDINATES_PROPERTY_NAME	COMMON_GEOGRAPHIC_COORDINATES_PROPERTY_NAME

/** GPS_GEOGRAPHIC_COORDINATES.LATITUDE property item name.
 */
#define GPS_GEOGRAPHIC_COORDINATES_LATITUDE_ITEM_NAME	COMMON_GEOGRAPHIC_COORDINATES_LATITUDE_ITEM_NAME

/** GPS_GEOGRAPHIC_COORDINATES.LONGITUDE property item name.
 */
#define GPS_GEOGRAPHIC_COORDINATES_LONGITUDE_ITEM_NAME	COMMON_GEOGRAPHIC_COORDINATES_LONGITUDE_ITEM_NAME

/** GPS_GEOGRAPHIC_COORDINATES.ELEVATION property item name.
 */
#define GPS_GEOGRAPHIC_COORDINATES_ELEVATION_ITEM_NAME	COMMON_GEOGRAPHIC_COORDINATES_ELEVATION_ITEM_NAME
 ...
 */
#define GPS_UTC_TIME_PROPERTY_NAME						COMMON_UTC_TIME_PROPERTY_NAME

/** GPS_UTC_TIME.UTC property item name.
 */
#define GPS_UTC_TIME_ITEM_NAME								COMMON_UTC_TIME_ITEM_NAME

/** GPS_UTC_TIME.OFFSET property item name.
 */
#define GPS_UTC_OFFSET_ITEM_NAME							COMMON_UTC_OFFSET_ITEM_NAME
