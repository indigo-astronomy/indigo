...
; Driver name/description metadata (equivalent of
; /usr/share/indigo/indigo_drivers on Linux), generated by
; make_indigo_drivers.exe; indigo_server.exe reads it from its own folder.
Source: "{#BuildDir}\indigo_drivers"; DestDir: "{app}\bin"; Flags: ignoreversion skipifsourcedoesntexist
